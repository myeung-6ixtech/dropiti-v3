        ...
        try {
          ...
          if (response.success && response.data) {
            ...
            setUser({
              ...
              avatar: userData.photo_url || session.user.image || '/src/assets/img/Portrait_Placeholder.png',
              // Additional user profile fields
              uuid: userData.uuid,
              displayName: userData.display_name,
              photoUrl: userData.photo_url || '/src/assets/img/Portrait_Placeholder.png',
            ...
            setUser({
              ...
              avatar: session.user.image || '/src/assets/img/Portrait_Placeholder.png',
              // Additional user profile fields with defaults
              uuid: undefined,
              displayName: session.user.name || 'User',
              photoUrl: session.user.image || '/src/assets/img/Portrait_Placeholder.png',
              location: undefined,
              about: undefined,
              education: undefined,
