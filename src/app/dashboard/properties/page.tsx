...
import { PlusIcon, MagnifyingGlassIcon, FunnelIcon, ViewColumnsIcon, ListBulletIcon, PencilIcon } from '@heroicons/react/24/outline';
            ...
            {properties.map((property) => (
              <div key={property.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2">{formatPropertyLocation(property.address)}</p>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Link
                      ...
                      className="flex-1 flex items-center justify-center px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium"
                    >
            ...
            {properties.map((property) => (
              <div key={property.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div className="flex space-x-2">
                  ...
                  <Link
                    href={`/dashboard/properties/edit/${property.id}`}
                    className="px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium whitespace-nowrap"
                  >
