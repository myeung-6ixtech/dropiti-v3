...
const TextArea: React.FC<TextareaProps> = ({
  ...
  let textareaClasses = `w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-sm placeholder:text-gray-400 focus:outline-hidden ${className}`;
